...
export const metadata: Metadata = {
  title: 'Sign Up | Finasddee',
  description: 'Create your Finasddee account to send and receive money securely and conveniently.',
}
            ...
            <div className="text-center">
              <nav className="mb-2 text-white/80">
                <ol className="inline-flex items-center space-x-2">
                  ...
                  <li className="opacity-100">Sign Up</li>
                </ol>
              </nav>
            ...
            <div className="container mx-auto px-4 text-black">
              <div className="max-w-xl mx-auto">
                <div className="bg-white shadow-md p-6">
                  ...
                  <p className="text-center mt-4">Your information is safe with us.</p>

                  <ClientSignupForm />

                  <p className="text-center mt-4">
                    Already have an account?{' '}
                    <Link href="/login" className="text-gold-dark hover:underline">Log In</Link>
                  </p>
                </div>
              </div>
            </div>
