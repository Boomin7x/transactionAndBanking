...
export function HelpPageContent() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-24 bg-cover bg-center" style={{ backgroundImage: 'url(/images/bg/image-2.jpg)' }}>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full py-3 px-4 pr-12 rounded-lg bg-white text-black focus:outline-none focus:ring-2 focus:ring-gold-light"
              />
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <Card className="text-center p-6">
              <UserCircle size={48} className="text-gold-dark mx-auto mb-4" />
            ...
            <Card className="text-center p-6">
              <Banknote size={48} className="text-gold-dark mx-auto mb-4" />
            ...
            <Card className="text-center p-6">
              <Shield size={48} className="text-gold-dark mx-auto mb-4" />
            ...
            <Card className="text-center p-6">
              <CreditCard size={48} className="text-gold-dark mx-auto mb-4" />
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-6 flex items-center">
              <Mail size={48} className="text-gold-dark mr-4 flex-shrink-0" />
              <div>
            ...
            <Card className="p-6 flex items-center">
              <MessageSquare size={48} className="text-gold-dark mr-4 flex-shrink-0" />
              <div>
