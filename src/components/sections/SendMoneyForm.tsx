...
import {
  sendMoneySchema,
  SendMoneyForm as SendMoneyFormType,
} from "@/lib/schemas";
import {
  useSenderCountries,
...
export function SendMoneyForm() {
  ...
  const { data: exchangeData, isLoading: isCalculating } = useExchangeRate(
    ...
    receiverCountries.find((c) => c.name === watchedValues.receiverCountry)
      ?.currency || "",
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl p-4 sm:p-6 w-full max-w-md mx-auto">
      <h3 className="text-xl sm:text-2xl font-bold text-dark-blue text-center mb-4">
        Send Money
      </h3>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
          <div className="sm:col-span-1">
            <p className="font-medium text-dark-blue mt-3 text-base sm:text-lg">
              Delivery methods
            </p>
          </div>
          <div className="sm:col-span-1">
